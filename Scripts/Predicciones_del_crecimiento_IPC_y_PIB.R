...
# Cargar datos
df1 <- read.csv("Datos/Originales/pib_ipc_paises_punto2.csv")
exogenas <- read.csv("Datos/Originales/exogenas_paises_punto2.csv")
paro<- read.csv("Datos/Originales/unemployment_germany.csv")
...
#guardar .csv
write.csv(ts_pib, file = "Datos/Limpios/seriePIB.csv", row.names = TRUE)
write.csv(ts_ipc, file = "Datos/Limpios/serieIPC.csv", row.names = TRUE)
...
#pasar a .csv 
write.csv2(df_pib_long, file = "Datos/Limpios/pred_real_pib.csv", row.names = FALSE)
write.csv2(df_ipc_long, file = "Datos/Limpios/pred_real_ipc.csv", row.names = FALSE)
