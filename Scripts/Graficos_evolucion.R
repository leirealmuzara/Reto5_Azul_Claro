...
#Asignamos paleta de colores
colores_trimestres_pib <- c("#93044e", "#d13d7b", "#f5a3b3", "#ffccd5")  
colores_trimestres_ipc <- c("#8db41c", "#4b8f0e", "#71c837", "#b9e973")  

source("Scripts/Predicciones_del_crecimiento_IPC_y_PIB.R")
source("Scripts/Predicciones_sin_covid.R")
...
desempleo<-read.csv("Datos/Originales/unemployment_germany.csv")
desempleo
colnames(desempleo)
